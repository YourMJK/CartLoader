This Spigot/PaperMC plugin loads chunks for moving minecarts automatically, enabling efficient long-distance transport with no players and no manual chunk loaders required.
